...
export default function AddCategory() {
    ...
    useEffect(() => {
        document.title= "Portfolio | rentizee | Add Category";
    }, [])
    ...
    const submitCategory = (e)=>{
        ...
        axios.post(`/api/submitcat`, data).then(res=>{
 ...
 <div className="container-fluid px-4">
        <h1 className="mt-4 text-success text-uppercase " >Add Category</h1>
    ...
    <div className="form-group mb-3">
                ...
                <input id="slug" type="text" name="slug" onKeyUp={(e)=>{e.target.value = e.target.value.toLowerCase()}} onChange={handleInput} value={categoryInput.slug} className="form-control" />
